...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">  التفسير النصي</h4><span
                    class="text-muted mt-1 tx-13 mr-2 mb-0">/
               اضافة تفسير نصي جديد</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('quran_text_interpretation.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                        <div class="col-12">
                        <label>السورة</label>
                ...
                <div class="col-12 col-md-12 text-center">
                        <button class="btn btn-success">اضافه تفسير نصي جديد</button>
                    </div>
                </div>
